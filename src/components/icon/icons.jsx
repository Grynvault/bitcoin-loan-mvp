...
export const UnlockedIcon = ({ size = 4 }) => (
	<svg
		xmlns='http://www.w3.org/2000/svg'
		fill='none'
		viewBox='0 0 24 24'
...
export const CloseIcon = ({ fillColor = 'black', width = 24 }) => (
